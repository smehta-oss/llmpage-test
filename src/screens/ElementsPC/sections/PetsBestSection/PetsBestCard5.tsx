...
const prosConsData = [
  {
    pro: "Comprehensive coverage includes behavioral therapy and alternative treatments in base policy",
    con: "Does not cover pre-existing conditions"
  },
  {
    pro: "Covers prescription food, supplements, and stem cell therapy",
    con: "Premiums can be higher for certain breeds"
  },
  {
    pro: "Includes end-of-life expenses such as euthanasia, burial, and cremation",
    con: "Some exclusions for hereditary conditions"
  },
  {
    pro: "Access to 24/7 pet telehealth line with licensed veterinarians",
    con: null
  }
];
        ...
        <CardContent className="p-0 space-y-6">
          <header className="flex items-center gap-2">
            <h2 className="[font-family:'Work_Sans',Helvetica] font-bold text-black text-2xl leading-8">
              <span className="underline">Spot</span>
            </h2>
              ...
              <>
                <div className="flex flex-col gap-6">
                  <div className="flex flex-col sm:flex-row gap-6 items-start">
                    <div className="flex flex-col items-center gap-3">
                      <div className="relative w-32 h-32">
                        <svg viewBox="0 0 120 120" className="w-full h-full -rotate-90">
                          ...
                          <circle cx="60" cy="60" r="50" fill="none" stroke="url(#gradient5)" strokeWidth="12" strokeDasharray="314" strokeDashoffset="79" strokeLinecap="round"/>
                          <defs><linearGradient id="gradient5" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stopColor="#DC2626"/><stop offset="50%" stopColor="#F59E0B"/><stop offset="100%" stopColor="#10B981"/></linearGradient></defs>
                        </svg>
                        <div className="absolute inset-0 flex items-center justify-center"><div className="text-center"><div className="text-3xl font-bold text-black">7.1</div><div className="text-sm text-gray-600">/10</div></div></div>
                      </div>
                    ...
                    <div className="flex flex-col items-center gap-2 border-l border-gray-200 pl-6"><div className="text-3xl font-bold text-[#007AC8]">6,890</div><div className="text-sm text-gray-600">Insights Analyzed</div></div>
                  </div>
                  <div className="border-t border-gray-200 pt-6"><div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4"><h4 className="font-bold text-lg text-black mb-2">Comprehensive base coverage</h4><p className="text-sm text-gray-700">Users ranked Spot #1 in included coverage benefits across 4.2k+ reviews</p></div></div>
                  <div><h4 className="font-bold text-lg text-black mb-4">What Pet Parents Say About Spot</h4><p className="text-base text-gray-700 leading-relaxed mb-4">Customers value Spot's inclusion of vet exam fees in the base policy, which many competitors charge extra for. The preventive care add-ons are reasonably priced. Some users report slower claim processing compared to top competitors...</p><button className="text-[#007AC8] font-semibold text-sm hover:underline">Read more</button></div>
                  <div className="flex flex-wrap gap-3 mb-4">
                    <div className="flex items-center gap-2 px-4 py-2 bg-green-50 border border-green-600 rounded-full"><span className="text-green-600 text-xl">↑</span><span className="font-semibold text-sm">Ranked #1 in Base Benefits</span></div>
                    <div className="flex items-center gap-2 px-4 py-2 bg-green-50 border border-green-600 rounded-full"><span className="text-green-600 text-xl">↑</span><span className="font-semibold text-sm">#2 in Value</span></div>
                    <div className="flex items-center gap-2 px-4 py-2 bg-yellow-50 border border-yellow-600 rounded-full"><span className="text-yellow-600 text-xl">→</span><span className="font-semibold text-sm">#4 in Claims Processing</span></div>
                    <div className="flex items-center gap-2 px-4 py-2 bg-yellow-50 border border-yellow-600 rounded-full"><span className="text-yellow-600 text-xl">→</span><span className="font-semibold text-sm">#4 in Customer Support</span></div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-gray-50 rounded-lg p-6"><div className="flex items-start gap-3 mb-4"><div className="text-3xl">👍</div><div><div className="font-semibold text-sm text-gray-900 mb-1">In 3.4k+ comparisons where Spot <span className="font-bold">was preferred</span>, people say it is</div></div></div><div className="flex flex-wrap gap-2"><span className="px-3 py-1.5 bg-white border border-gray-300 rounded-full text-sm">Includes Exam Fees (780+)</span><span className="px-3 py-1.5 bg-white border border-gray-300 rounded-full text-sm">Good Value (690+)</span><span className="px-3 py-1.5 bg-white border border-gray-300 rounded-full text-sm">Unlimited Coverage (510+)</span></div></div>
                    <div className="bg-gray-50 rounded-lg p-6"><div className="flex items-start gap-3 mb-4"><div className="text-3xl">👎</div><div><div className="font-semibold text-sm text-gray-900 mb-1">In 2.3k+ comparisons where Spot <span className="font-bold">was not preferred</span>, people say it is</div></div></div><div className="flex flex-wrap gap-2"><span className="px-3 py-1.5 bg-white border border-gray-300 rounded-full text-sm">Slow Claims (720+)</span><span className="px-3 py-1.5 bg-white border border-gray-300 rounded-full text-sm">Limited App Features (390+)</span><span className="px-3 py-1.5 bg-white border border-gray-300 rounded-full text-sm">Support Response Time (280+)</span></div></div>
                  </div>
                </div>
              </>
            )}
