...
const prosConsData = [
  {
    pro: "Unique Healthy Pet Discount Program offers up to 10% savings for healthy pets",
    con: "Does not cover pre-existing conditions"
  },
  {
    pro: "Offers multi-pet discounts for insuring multiple pets",
    con: "Limited coverage for routine wellness care in base policy"
  },
  {
    pro: "Diminishing deductible feature reduces your deductible by $50 for each year without a claim",
    con: "Some hereditary and congenital conditions may have waiting periods"
  },
  {
    pro: "Covers alternative therapies including acupuncture and hydrotherapy",
    con: null
  }
];
        ...
        <CardContent className="p-0 space-y-6">
          <header className="flex items-center gap-2">
            <h2 className="[font-family:'Work_Sans',Helvetica] font-bold text-black text-2xl leading-8">
              <span className="underline">Embrace</span>
            </h2>
              ...
              <>
                <div className="flex flex-col gap-6">
                  <div className="flex flex-col sm:flex-row gap-6 items-start">
                    <div className="flex flex-col items-center gap-3">
                      <div className="relative w-32 h-32">
                        <svg viewBox="0 0 120 120" className="w-full h-full -rotate-90">
                          ...
                          <circle cx="60" cy="60" r="50" fill="none" stroke="url(#gradient4)" strokeWidth="12" strokeDasharray="314" strokeDashoffset="69" strokeLinecap="round"/>
                          <defs><linearGradient id="gradient4" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stopColor="#DC2626"/><stop offset="50%" stopColor="#F59E0B"/><stop offset="100%" stopColor="#10B981"/></linearGradient></defs>
                        </svg>
                        <div className="absolute inset-0 flex items-center justify-center"><div className="text-center"><div className="text-3xl font-bold text-black">7.4</div><div className="text-sm text-gray-600">/10</div></div></div>
                      </div>
                    ...
                    <div className="flex flex-col items-center gap-2 border-l border-gray-200 pl-6"><div className="text-3xl font-bold text-[#007AC8]">7,180</div><div className="text-sm text-gray-600">Insights Analyzed</div></div>
                  </div>
                  <div className="border-t border-gray-200 pt-6"><div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4"><h4 className="font-bold text-lg text-black mb-2">Diminishing deductible rewards loyalty</h4><p className="text-sm text-gray-700">Users ranked Embrace #1 in customer rewards programs across 3.5k+ reviews</p></div></div>
                  <div><h4 className="font-bold text-lg text-black mb-4">What Pet Parents Say About Embrace</h4><p className="text-base text-gray-700 leading-relaxed mb-4">Customers appreciate Embrace's unique diminishing deductible feature that rewards claim-free years. The Wellness Rewards program is flexible. However, some find the 6-month orthopedic waiting period lengthy...</p><button className="text-[#007AC8] font-semibold text-sm hover:underline">Read more</button></div>
                  <div className="flex flex-wrap gap-3 mb-4">
                    <div className="flex items-center gap-2 px-4 py-2 bg-green-50 border border-green-600 rounded-full"><span className="text-green-600 text-xl">↑</span><span className="font-semibold text-sm">Ranked #1 in Rewards</span></div>
                    <div className="flex items-center gap-2 px-4 py-2 bg-green-50 border border-green-600 rounded-full"><span className="text-green-600 text-xl">↑</span><span className="font-semibold text-sm">#2 in Customer Service</span></div>
                    <div className="flex items-center gap-2 px-4 py-2 bg-yellow-50 border border-yellow-600 rounded-full"><span className="text-yellow-600 text-xl">→</span><span className="font-semibold text-sm">#3 in Premiums</span></div>
                    <div className="flex items-center gap-2 px-4 py-2 bg-yellow-50 border border-yellow-600 rounded-full"><span className="text-yellow-600 text-xl">→</span><span className="font-semibold text-sm">#4 in Waiting Periods</span></div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-gray-50 rounded-lg p-6"><div className="flex items-start gap-3 mb-4"><div className="text-3xl">👍</div><div><div className="font-semibold text-sm text-gray-900 mb-1">In 3.8k+ comparisons where Embrace <span className="font-bold">was preferred</span>, people say it is</div></div></div><div className="flex flex-wrap gap-2"><span className="px-3 py-1.5 bg-white border border-gray-300 rounded-full text-sm">Diminishing Deductible (920+)</span><span className="px-3 py-1.5 bg-white border border-gray-300 rounded-full text-sm">Wellness Rewards (710+)</span><span className="px-3 py-1.5 bg-white border border-gray-300 rounded-full text-sm">Responsive Support (540+)</span></div></div>
                    <div className="bg-gray-50 rounded-lg p-6"><div className="flex items-start gap-3 mb-4"><div className="text-3xl">👎</div><div><div className="font-semibold text-sm text-gray-900 mb-1">In 2.1k+ comparisons where Embrace <span className="font-bold">was not preferred</span>, people say it is</div></div></div><div className="flex flex-wrap gap-2"><span className="px-3 py-1.5 bg-white border border-gray-300 rounded-full text-sm">Long Waiting Periods (650+)</span><span className="px-3 py-1.5 bg-white border border-gray-300 rounded-full text-sm">Premium Increases (480+)</span><span className="px-3 py-1.5 bg-white border border-gray-300 rounded-full text-sm">Limited Vet Network (220+)</span></div></div>
                  </div>
                </div>
              </>
            )}
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                      <li className="[font-family:'Work_Sans',Helvetica] text-[#333333] text-base leading-[26px]">
                        Wellness Rewards: $250 to $650 per year for routine care
                      </li>
                      <li className="[font-family:'Work_Sans',Helvetica] text-[#333333] text-base leading-[26px]">
                        Healthy Pet Deductible Discount: Reduces deductible by $50 annually
                      </li>
                    </ul>
                  </div>
                    ...
                    <table className="w-full border-collapse">
                      ...
                      <tbody>
                        ...
                        <tr className="bg-[#F8F8FA] border-b border-[#E5E7EB]">
                          ...
                          <td className="p-4 [font-family:'Work_Sans',Helvetica] text-[#333333] text-base leading-[26px]">
                            14 days for accidents and illnesses; 6 months for orthopedic conditions
                          </td>
                        </tr>
                        <tr className="border-b border-[#E5E7EB]">
                          <td className="p-4 [font-family:'Work_Sans',Helvetica] text-[#333333] text-base leading-[26px]">
                          ...
                          <td className="p-4 [font-family:'Work_Sans',Helvetica] text-[#333333] text-base leading-[26px]">
                            Available for pets as young as 6 weeks; no upper age limit for new policies
                          </td>
                        </tr>
                        <tr className="bg-[#F8F8FA] border-b border-[#E5E7EB]">
                          <td className="p-4 [font-family:'Work_Sans',Helvetica] text-[#333333] text-base leading-[26px]">
